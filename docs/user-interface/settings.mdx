...
The settings window is opened by clicking the `Settings` item in the main window's cog menu. Use this window to configure Polkadot Live to your preferences. Please refer to the [Application Settings](/category/settings) documentation to learn about what each setting accomplishes.

...
description: Tracks screen UI documentation.
---
...
Displays track information for the selected blockchain network.

<Img url="/img/ui/ui-opengov-tracks-01.png" maxHeight="400px" />

### 1. Sorting controls

Use the sorting controls to customize how the track data is listed. The sorting controls row comprises the following buttons (documented from left to right):
...
An track row includes the following items (from left to right):

- __Origin ID__<br />
  The origin ID that is defined as a constant on the blockchain network.

- __Track Name__<br />
  The readable track name that is defined as a constant on the blockchain network.
...
- __Max. Deciding__<br />
  Maximum amount of referenda that can be active and ongoing with the respective track.

- __Timeline__<br />
  A button that will expand and collapse additional information related to the track.

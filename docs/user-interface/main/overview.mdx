...
<Img url="/img/ui/ui-main-cog-menu.png" maxHeight="300px" />
...
- __Exit__<br />
  Quits the Polkadot Live application.

- __Disclaimer__<br />
  Opens the disclaimer text in an overlay.

- __Privacy__<br />
  Opens the privacy text in an overlay.

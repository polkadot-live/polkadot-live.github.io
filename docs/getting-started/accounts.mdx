...
We know that both of our account's spendable balance has changed by inspecting the main window's `Events` tab. As you can see, we received two event items that notify us or our account's new spendable balances.

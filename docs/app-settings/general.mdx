...
Controls whether to display Polkadot Live windows on all workspaces in your OS desktop environment.

### Turned On

The Polkadot Live main window and all child windows will be rendered in every OS workspace.

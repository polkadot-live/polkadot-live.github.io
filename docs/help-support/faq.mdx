...
### How do I open and close Polkadot Live?
Double click on your system's Polkadot Live application icon to launch the program. A **tray icon** will be displayed in the system's menu bar (macOS) or taskbar tray (Windows). Clicking the tray icon will show and hide the main window accordingly. Close the application altogether by selecting **Exit** from the main window's cog menu.
